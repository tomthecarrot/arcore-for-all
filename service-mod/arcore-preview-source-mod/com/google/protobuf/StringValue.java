  ...
  implements StringValueOrBuilder
{
  ...
  {
    return (Builder)((Builder)DEFAULT_INSTANCE.toBuilder()).mergeFrom(paramStringValue);
  }
  ...
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramByteString);
  }
  
  public static StringValue parseFrom(ByteString paramByteString, ExtensionRegistryLite paramExtensionRegistryLite)
    throws InvalidProtocolBufferException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramByteString, paramExtensionRegistryLite);
  }
  
  public static StringValue parseFrom(CodedInputStream paramCodedInputStream)
    throws IOException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramCodedInputStream);
  }
  ...
  public static StringValue parseFrom(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
    throws IOException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramCodedInputStream, paramExtensionRegistryLite);
  }
  
  public static StringValue parseFrom(InputStream paramInputStream)
    throws IOException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  
  public static StringValue parseFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite)
    throws IOException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static StringValue parseFrom(byte[] paramArrayOfByte)
    throws InvalidProtocolBufferException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramArrayOfByte);
  }
  
  public static StringValue parseFrom(byte[] paramArrayOfByte, ExtensionRegistryLite paramExtensionRegistryLite)
    throws InvalidProtocolBufferException
  {
    return (StringValue)GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, paramArrayOfByte, paramExtensionRegistryLite);
  }
  ...
  {
    // Byte code:
    //   0: getstatic 142	com/google/protobuf/StringValue$1:$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke	[I
    //   3: aload_1
    ...
    //   63: athrow
    //   64: new 2	com/google/protobuf/StringValue
    //   67: dup
    //   68: invokespecial 27	com/google/protobuf/StringValue:<init>	()V
    //   71: astore_1
    //   72: aload_1
    //   73: areturn
    //   74: getstatic 29	com/google/protobuf/StringValue:DEFAULT_INSTANCE	Lcom/google/protobuf/StringValue;
    //   77: areturn
    //   78: aconst_null
    //   79: areturn
    //   80: new 11	com/google/protobuf/StringValue$Builder
    //   83: dup
    //   84: aconst_null
    //   85: invokespecial 154	com/google/protobuf/StringValue$Builder:<init>	(Lcom/google/protobuf/StringValue$1;)V
    //   88: areturn
    //   89: aload_2
    //   90: checkcast 156	com/google/protobuf/GeneratedMessageLite$Visitor
    //   93: astore_2
    //   94: aload_3
    //   95: checkcast 2	com/google/protobuf/StringValue
    //   98: astore_1
    //   99: aload_0
    //   100: getfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    //   103: invokevirtual 162	java/lang/String:isEmpty	()Z
    //   106: ifne +54 -> 160
    //   109: iconst_1
    //   110: istore 6
    //   112: aload_0
    //   113: getfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    //   116: astore_3
    //   117: aload_1
    //   118: getfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    ...
    //   135: iload 7
    //   137: aload_1
    //   138: getfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    //   141: invokeinterface 166 5 0
    //   146: putfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    //   149: aload_0
    //   150: astore_1
    //   151: aload_2
    ...
    //   244: putfield 38	com/google/protobuf/StringValue:value_	Ljava/lang/String;
    //   247: goto -62 -> 185
    //   250: astore_1
    ...
    //   290: athrow
    //   291: getstatic 29	com/google/protobuf/StringValue:DEFAULT_INSTANCE	Lcom/google/protobuf/StringValue;
    //   294: areturn
    //   295: getstatic 202	com/google/protobuf/StringValue:PARSER	Lcom/google/protobuf/Parser;
    //   298: ifnonnull +28 -> 326
    //   301: ldc 2
    //   303: monitorenter
    //   304: getstatic 202	com/google/protobuf/StringValue:PARSER	Lcom/google/protobuf/Parser;
    //   307: ifnonnull +16 -> 323
    //   310: new 204	com/google/protobuf/GeneratedMessageLite$DefaultInstanceBasedParser
    //   313: dup
    //   314: getstatic 29	com/google/protobuf/StringValue:DEFAULT_INSTANCE	Lcom/google/protobuf/StringValue;
    ...
    //   320: putstatic 202	com/google/protobuf/StringValue:PARSER	Lcom/google/protobuf/Parser;
    //   323: ldc 2
    //   325: monitorexit
    //   326: getstatic 202	com/google/protobuf/StringValue:PARSER	Lcom/google/protobuf/Parser;
    //   329: areturn
    //   330: astore_1
    //   331: ldc 2
    //   333: monitorexit
    ...
    implements StringValueOrBuilder
  {
    ...
    {
      copyOnWrite();
      ((StringValue)this.instance).setValue(paramString);
      return this;
    }
    ...
    {
      copyOnWrite();
      ((StringValue)this.instance).setValueBytes(paramByteString);
      return this;
    }
  }
}
...
/* Location:              /Users/tom/Downloads/dex2jar-2.0/classes.jar!/com/google/protobuf/StringValue.class
